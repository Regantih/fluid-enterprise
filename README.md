...
Each generation: fitness improves, weak strategies dissolve, strong patterns propagate, and the system approaches its theoretical performance ceiling with diminishing returns — exactly like AlphaZero's learning curve.

---

## Architecture

### Capabilities — Living Clusters (Not Modules)

| Capability | Domain | What It Does |
|------------|--------|--------------|
| **Procurement Intelligence** | Procurement | Autonomous sourcing, vendor evaluation, PO generation |
| **Financial Operations** | Finance | Real-time GL, AP/AR automation, period-close orchestration |
| **Logistics Orchestration** | Logistics | Warehouse ops, route optimization, carrier management |
| **Demand Planning** | Planning | Forecast modeling, inventory optimization, S&OP |
| **Workforce Intelligence** | Workforce | Talent analytics, scheduling, compensation modeling |
| **Customer Revenue Engine** | Customer | Pipeline management, churn prediction, pricing optimization |
| **Asset Lifecycle Management** | Finance | Fixed assets, depreciation, predictive maintenance |
| **Compliance & Risk Engine** | Finance | Regulatory monitoring, audit trail, control testing |
...
| **Governance Board** | Human-in-the-loop approval queue + Council peer reviews |
...
Open `http://localhost:5000`. The simulation engine starts immediately — agents evolve, capabilities improve, costs accumulate, and governance requests flow in real time.
...
- **Evolution Engine**: Generational fitness tracking, self-play simulation, council protocol
- **Live Simulation**: Heartbeats, cost generation, trust evolution, capability improvement
...
- **Real LLM Integration** — Connect the orchestrators to actual language models
